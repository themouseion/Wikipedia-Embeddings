...
for file_id in file_ids:
    try:
        ...
        index = faiss.IndexIVFScalarQuantizer(quantizer, 384, nlist, faiss.ScalarQuantizer.QT_8bit)
        index.train(embeddings_np)  # Training step
        index.add(embeddings_np)
        logger.info(f"FAISS IVFScalarQuantizer index built with {index.ntotal} vectors.")
